...
local Window = Library.CreateLib("Simple Ball - BXLESKY", "DarkTheme")

local Tab = Window:NewTab("Main")

local Tab2 = Window:NewTab("Crates")

local Tab3 = Window:NewTab("Visual")

local Combat = Tab:NewSection("Combat")

local Shop = Tab2:NewSection("Crates")
...
Combat:NewToggle("Hit Effect", "Adds Effect When Ball Is Hit", function(toggled)

    getgenv().hit_effect_Enabled = toggled

end)

Shop:NewButton("SwordCrate", "Opens Sword Crate (Need Enough Money)", function()
...
Shop:NewButton("ExplosionCrate", "Opens Explosion Crate (Need Enough Money)", function()
...
Visual:NewToggle("Night/Day", "Toggles Night/Day", function(toggled)

    getgenv().night_mode_Enabled = toggled

end)

Visual:NewToggle("Trail", "Adds A Trail To You", function(toggled)

    getgenv().trail_Enabled = toggled

end)

Visual:NewToggle("No Lag", "Removes MOST Lag", function(toggled)
